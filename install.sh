...
bootstrap_usage() {
  printf "\n"
  printf "  NemoClaw Installer (bootstrap)\n\n"
  printf "  Usage:\n"
  ...
  printf "    --yes-i-accept-third-party-software     Accept the third-party software notice\n"
  printf "    --fresh                                 Discard any failed/interrupted session and start over\n"
  printf "    --version, -v                           Print installer version and exit\n"
  printf "    --help, -h                              Show this help message and exit\n\n"
  printf "  Note:\n"
  printf "    The bootstrap clones the requested ref and re-execs scripts/install.sh.\n"
  printf "    Run 'scripts/install.sh --help' from the clone for the FULL option/env reference\n"
  printf "    (platform override, backend selection, policies, smoke tests, state paths, etc.).\n\n"
  printf "  Environment (most-used — see scripts/install.sh --help for the full list):\n"
